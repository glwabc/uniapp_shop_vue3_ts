...
> - pnpm install      在项目根目录安装依赖
> - pnpm dev:mp-weixin      编译微信小程序（dist/dev/mp-weixin）
...
完成自动导入设置后，即可在 .vue页面中使用uni-ui，不需要手动导入了
...
uni-ui官方并没有提供对应的类型声明文件，需要安装第三方扩展包然后再配置类型声明文件
